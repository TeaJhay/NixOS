{
  ...
  hjem = {
    ...
    users.teajhay = {
      ...
      xdg.config.files."noctalia/settings.toml".source = config.security.nix-secrets.templates."noctalia-settings.toml".path;
    };
  };

  security.nix-secrets.templates."noctalia-settings.toml" = {
    owner = "teajhay";
    content = builtins.readFile (
      (pkgs.formats.toml {}).generate "settings.toml" {
        audio = {
        ...
        widget = {
          ...
          toggle = {
            type = "alexander/screen-toolkit:panel";
          };
          volume = {
            actions = {
