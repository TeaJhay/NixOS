...
hl.animation({leaf = "windows", enabled = true, speed = prod(8), spring = "macOpen", style = "gnomed"})
hl.animation({leaf = "windowsIn", enabled = true, speed = prod(8), spring = "macOpen", style = "gnomed"})
hl.animation({leaf = "windowsOut", enabled = true, speed = prod(7), spring = "macBounce", style = "gnomed"})
